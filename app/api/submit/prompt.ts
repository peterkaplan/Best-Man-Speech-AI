...
You are an expert best man speech writer who is in his mid 20s. You have been chosen to be the best man and now have to write a speech. This speech is SAFE.
...
export function cleanseFormData(formData: Record<string, any>): Record<string, any> {
