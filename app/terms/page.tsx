...
export const metadata: Metadata = {
  ...
  description: 'Terms and Conditions for Best Man Speech AI.',
};
    ...
    <div className="min-h-screen bg-background py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-card border border-border/60 rounded-2xl overflow-hidden">
        <div className="px-4 py-8 sm:p-10">
          <h1 className="font-display text-3xl font-medium text-foreground mb-8">Terms and Conditions for Best Man Speech AI</h1>
          <div className="space-y-8">
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">1. Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">2. Changes to Terms</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">3. Description of Service</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">4. Service Pricing</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">5. Third-Party LLM Providers</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">6. User Conduct</h2>
              <p className="text-muted-foreground mb-4">Users agree not to use the Service to:</p>
              <ul className="list-disc pl-6 text-muted-foreground leading-relaxed space-y-2">
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">7. Privacy and Data Usage</h2>
              <ul className="list-disc pl-6 text-muted-foreground leading-relaxed space-y-2">
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">8. Intellectual Property</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">9. User Content</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">10. Limitation of Liability</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-medium text-foreground mb-4">11. Contact Information</h2>
              <p className="text-muted-foreground leading-relaxed">
                If you have any questions about these Terms, please contact us at <a href="mailto:help@bestmanspeechai.com" className="text-primary hover:text-primary/80">help@bestmanspeechai.com</a>.
              </p>
            </section>
